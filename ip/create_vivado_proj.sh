...
print_usage () {
  ...
  echo "- the 1st:     BOARD_NAME (antsdr antsdr_e200 e310v2 sdrpi zc706_fmcs2 zed_fmcs2 zc702_fmcs2 adrv9361z7035 adrv9364z7020 zcu102_fmcs2 zusdr_mini neptunesdr)"
