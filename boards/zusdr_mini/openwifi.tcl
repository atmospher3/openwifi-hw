...
#
# Generated by Vivado on Sat May 11 23:23:55 CST 2024
...
set _xil_proj_name_ "openwifi_zusdr_mini"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu3eg-sfvc784-2-i
...
set_property -name "part" -value "xczu3eg-sfvc784-2-i" -objects $obj
...
set file "$origin_dir/src/system.bd"
...
set file "$origin_dir/src/system_top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/src/system_constr.xdc"
set file [file normalize $file]
...
set_property -name "target_part" -value "xczu3eg-sfvc784-2-i" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu3eg-sfvc784-2-i -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/openwifi_zusdr_mini.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfvc784-2-i -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/openwifi_zusdr_mini.srcs/utils_1/imports/impl_1" -objects $obj
