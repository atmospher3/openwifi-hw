...
if [ "$#" -ne 2 ]; then
    ...
    echo "Like: antsdr antsdr_e200 sdrpi e310v2 adrv9364z7020 adrv9361z7035 zc706_fmcs2 zed_fmcs2 zc702_fmcs2 zcu102_fmcs2 zcu102_9371 zusdr_mini neptunesdr"
    exit 1
fi
